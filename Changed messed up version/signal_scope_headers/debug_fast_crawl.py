...
signals1 = ['prepare_swingingLF','prepare_swingingRF','prepare_swingingLH','prepare_swingingRH']

#signals2 = [ 'legToSwingLF', 'legToSwingRF', 'legToSwingLH', 'legToSwingRH', 'loadingFlag']

signals2 = [ 'footPosDesLFz','footPosDesRFz','footPosDesLHz','footPosDesRHz']

#signals3 = ['gait_swing_statusLF','gait_swing_statusRF','gait_swing_statusLH','gait_swing_statusRH']
signals4 = ['swingDurationLF','swingDurationRF','swingDurationLH','swingDurationRH','settlingTime']
#signals2 = ['des_baseX' , 'actual_CoMX']


#signals3 = ['linearSpeedX']
signals3 = ['des_baseY']
#signals4 = ['des_base_pitch', 'pitch']


#signals2 = ['des_base_roll', 'roll']
...
signals5 =['stridePhase', 'reachingMotion', 'cycle_time'] #

#signals4 = ['baseTwistLx','baseTwistLy', 'baseTwistLz','baseTwistAx','baseTwistAy','baseTwistAz']
#signals3 = ['footPosDesLHz','footPosLHz', 'footPosDesLFz','footPosLFz', 'footPosDesRHz','footPosRHz']
