...
addPlot()
lf_1 = ['lf_haa_joint_u_des','lf_haa_joint_u_hyd','lf_haa_joint_u']
addSignals('MOTOR', msg.usec, msg.array, lf_1, keyLookup=msg.name)

addPlot()
lf_2 = ['lf_hfe_joint_u_des','lf_hfe_joint_u_hyd','lf_hfe_joint_u']
addSignals('MOTOR', msg.usec, msg.array, lf_2, keyLookup=msg.name)

addPlot()
lf_3 = ['lf_kfe_joint_u_des','lf_kfe_joint_u_hyd','lf_kfe_joint_u']
