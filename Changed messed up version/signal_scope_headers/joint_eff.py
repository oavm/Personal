...
addPlot()
joints = ['lf_haa_joint']
addSignals('ROBOT_ACT_JS', msg.utime, msg.joint_effort, joints, keyLookup=msg.joint_name)
addSignals('ROBOT_DES_JS', msg.utime, msg.joint_effort, joints, keyLookup=msg.joint_name)
