...
\begin{frame}{Control objectives}
	\begin{itemize}\setlength\itemsep{1.5em}
		...
		\item Rely only on local measurements
	\end{itemize}
\end{frame}
...
\begin{itemize}\setlength\itemsep{0.9em}
	...
	\item Synthesize controller and observer gains for each isolated system separately
...
\begin{itemize}
	...
	\item Optimize location of right-most pole over $K_i$ (state-feedback gains) and $L_i$ (observer-feedback gains)
\end{itemize}
...
\begin{center}
        \movie[width=0.9\textwidth,showcontrols=true]
       {\includegraphics[width=0.9\textwidth]{Legs.png}}{Legs.mp4} \\
\end{center}
