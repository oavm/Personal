...
\AtBeginSection {
	\begin{frame}<beamer>[plain] \frametitle{\titleSubsec}
	
		\tableofcontents[sections=\thesection]  % Generation of the Table of Contents
	\end{frame}
}
...
\author{Octavio Villarreal \vspace{20pt}} %\scriptsize Committee:  \\ Prof.Dr.Ir. Nathan van de Wouw (TUDelft, supervisor) \\ \vspace{1.5pt} \hspace{-11pt}Prof.Dr.Ir. Emmanuel Detournay (UMN, supervisor) \\ \vspace{-2.5pt} \hspace{-74pt}Dr.Ir. Manuel Mazo Jr. (TUDelft)}
